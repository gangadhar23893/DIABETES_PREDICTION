...
from diabetes_prediction.entity.config_entity import DataIngestionConfig,DataValidationConfig
from diabetes_prediction.entity.config_entity import TrainingPipelineConfig
import sys
